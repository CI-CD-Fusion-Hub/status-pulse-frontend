...
const options = {
  Private: "Only people who have access can view",
...
<template>
  <div class="dropdown-holder">
    ...
    <div class="dropdown-field">
      <a href="javascript:;" class="drop-down-btn" @click="toggleDropdown">
        <div>
      ...
      <div class="dropdown-menu" :is-visible="isOpen">
        <ul>
          ...
          >
            <a href="javascript:;" @click="selectValue(val)"
              >{{ key }}<i v-if="data === val" class="bx bx-check"
            /></a>
          </li>
        </ul>
      </div>
    ...
    <p v-else>Anyone on the internet with the link can view this dashboard</p>
  </div>
</template>
